...
/**
 * @package   Learts_Framework
 */

if ( class_exists( 'Walker_Nav_Menu' ) && ! class_exists( 'Learts_Walker_Nav_Menu' ) ) {

	class Learts_Walker_Nav_Menu extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( $css ) {
				...
				$js_output .= '_leartsInlineStyle.textContent+=\'' . Learts_Helper::text2line( $css ) . '\';';
				$js_output .= '}';
				wp_add_inline_script( 'learts-main-js', Learts_Helper::text2line( $js_output ) );
			}
	...
	add_filter( 'insight_core_bmw_nav_args', 'learts_add_extra_params_to_insightcore_bmw' );
	function learts_add_extra_params_to_insightcore_bmw( $args ) {
