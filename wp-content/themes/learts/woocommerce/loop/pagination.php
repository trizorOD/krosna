...
$pagination = learts_get_option( 'shop_pagination' );
	...
	<nav class="woocommerce-pagination">
		...
		echo paginate_links( apply_filters( 'woocommerce_pagination_args',
			array(
				...
				'total'     => $total,
				'prev_text' => '<i class="ion-ios-arrow-thin-left" aria-hidden="true"></i>',
				'next_text' => '<i class="ion-ios-arrow-thin-right" aria-hidden="true"></i>',
				'type'      => 'list',
				'end_size'  => 3,
				'mid_size'  => 3,
			) ) );
...
<?php else :
	...
	$load_more_atts = array(
		...
		'posts_per_page' => apply_filters( 'learts_ajax_products_per_page',
	...
	<div class="learts-loadmore-wrap woocommerce-pagination"
		...
		<a href="#"
		   class="button learts-loadmore-btn load-on-<?php echo esc_attr( $pagination == 'more-btn' ) ? 'click' : 'scroll'; ?>"><?php esc_html_e( 'more',
				'learts' ); ?></a>
	</div>
<?php endif; ?>
