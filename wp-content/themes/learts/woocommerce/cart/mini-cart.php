...
<?php if ( learts_get_option( 'minicart_message_pos' ) == 'top' && ! WC()->cart->is_empty() ) { ?>
	<p class="minicart-message"><?php echo learts_get_option( 'minicart_message' ) ?></p>
<?php } ?>
<p class="widget_minicart_title"><?php esc_html_e( 'Cart', 'learts' ); ?>
				...
				<li class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class',
					...
					echo apply_filters( 'woocommerce_cart_item_remove_link',
						sprintf( '<a href="%s" class="remove" title="%s" data-product_id="%s" data-product_sku="%s" data-cart_item_key="%s" >&times;</a>',
							...
							esc_html__( 'Remove this item', 'learts' ),
							esc_attr( $product_id ),
					...
					<div class="minicart_item_right">
						<div class="product-title"><a
								href="<?php echo esc_url( $_product->get_permalink( $cart_item ) ); ?>"><?php echo wp_kses( $product_name,
...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<p class="woocommerce-mini-cart__total total"><strong><?php esc_html_e( 'Subtotal', 'learts' ); ?>
	...
	<p class="woocommerce-mini-cart__buttons buttons">
		<a href="<?php echo esc_url( wc_get_cart_url() ); ?>"
		   class="button wc-forward"><?php esc_html_e( 'View Cart', 'learts' ); ?></a>
		<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>"
		   class="button checkout alt-button wc-forward"><?php esc_html_e( 'Checkout', 'learts' ); ?></a>
	</p>

<?php endif; ?>

<?php if ( learts_get_option( 'minicart_message_pos' ) == 'bottom' && ! WC()->cart->is_empty() ) { ?>
	<p class="minicart-message"><?php echo learts_get_option( 'minicart_message' ) ?></p>
<?php } ?>
