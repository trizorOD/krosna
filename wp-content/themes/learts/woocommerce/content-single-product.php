...
$product_bgcolor = get_post_meta( Learts_Helper::get_the_ID(), 'learts_product_bgcolor', true );
...
if ( get_post_meta( Learts_Helper::get_the_ID() , 'learts_page_title_on', true ) !== 'on' ) {
	if ( get_post_meta( Learts_Helper::get_the_ID() , 'learts_page_title_on', true ) !== 'default' && learts_get_option( 'page_title_on' ) === false ) {
...
if ( learts_get_option( 'product_ajax_add_to_cart' ) ) {
...
<div id="product-<?php the_ID(); ?>" <?php post_class( $product_class ); ?>>
	...
	<div class="container">
		...
		if ( ! get_post_meta( Learts_Helper::get_the_ID(), 'learts_hide_related_products', true ) == 'on' ) {
			woocommerce_output_related_products();
		}
		?>
	</div>
	<?php echo Learts_Woo::product_instagram(); ?>
