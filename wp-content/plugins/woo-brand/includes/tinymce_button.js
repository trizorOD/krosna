			...
			<div class="flash_sale-shortcodes-form-tab" id="flash_sale-shortcodes-form-tab_a-z-view" style="display:block">\
				...
				<table cellpadding="0" cellspacing="0">\
					<tr>\
						...
						<td>\
							<select fieldname="pw_layout" class="pw_layout">\
								<option value="wb-layout-1">One Column</option>\
								<option value="wb-layout-2">Multi Columns</option>\
							</select>\
						</td>\
					</tr>\
					<tr class="tr-layout-az2">\
					...
					<tr>\
						<th><label>Display Count</label></th>\
						<td>\
...
<!-- All Views -->\
			...
			<!-- Start Simple-->\
					<tr>\
						<th><label>Display Brands</label></th>\
						<td>\
							<select fieldname="pw_featured">\
								<option value="all">All Brand`s</option>\
								<option value="featured">Only Featured Brand</option>\
								<option value="exclude_featured">Exclude Featured Brand</option>\
							</select>\
						</td>\
					</tr>\
					<tr>\
...
<!-- end tab top_products Grid-->\
	...
	jQuery('.tr-layout-az2').dependsOn({
		'.pw_layout': {
			values: ['wb-layout-2']
		}
	});
	jQuery('.tr-layout-az1').dependsOn({
		'.pw_layout': {
			values: ['wb-layout-1']
		}
	});	
