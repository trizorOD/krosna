    ...
    <div class="term-description brand-description">
        ...
        <?php if ($thumbnail) :
            ...
            if ($url != "") {
                ...
                <a href="<?php echo $url; ?>"><img style="width: <?php echo $width; ?>;height: <?php echo $height; ?>"
                                                   src="<?php echo $thumbnail; ?>" alt="<?php echo $name; ?>"></a>
            <?php } else { ?>
                <img src="<?php echo $thumbnail; ?>" style="width: <?php echo $width; ?>;height: <?php echo $height; ?>"
                     alt="<?php echo $name; ?>"/>
            <?php } ?>
        <?php endif;
