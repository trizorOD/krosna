...
/*	*/
	...
	private function pw_woocommerce_brands_plugin_options() {
		$options['general_settings'] = array(
			...
			array(
				'title' => __( 'Customize "Brand" Label', 'woocommerce-brands' ),
			...
			array(
				...
				'options'   => array(
					...
					'after_price' => __( 'After price', 'woocommerce-brands' ),
			...
			array(
				'name'      =>  'Enable Sort by Brand' ,
				'desc'      => __( 'Enable "Sort by Brand" option in shop archive page', 'woocommerce-brands'), 
				'id'        => 'pw_woocommerce_enable_brand_sorting',
				'std' 		=> 'yes',         // for woocommerce < 2.0
				'default' 	=> 'no',         // for woocommerce >= 2.0
				'type'      => 'checkbox'
			),	
			array(
				'name'      =>  'Show Brand in product tab' ,
				'desc'      => __( 'Show brand tab in single product page', 'woocommerce-brands'), 
				'id'        => 'pw_woocommerce_enable_brand_tab',
				'std' 		=> 'yes',         // for woocommerce < 2.0
				'default' 	=> 'no',         // for woocommerce >= 2.0
				'type'      => 'checkbox'
			),				
...
/*			array(
	...
	$options['brands_settings'] = array(
		...
		/*	array(
				'name'      =>  '' ,
				'desc'      => __( "Display Brand's In product`s Page(shop page)", 'woocommerce-brands'), 
		...
		*/
			...
			array(
				'name'      =>  '' ,
				'desc'      => __( "Display Brand's Description In Single product", 'woocommerce-brands'), 
			...
			array(
				'name'      => '',
				'desc'      => __( "Display Brand's Description In product List", 'woocommerce-brands'), 
			...
			array(
				'name'      => '',
				'desc'      => __( "Display Brand's Text In Single product", 'woocommerce-brands'), 
			...
			array(
				'name'      => '',
				'desc'      => __( "Display Brand's Image In Single product", 'woocommerce-brands'), 
		...
		$options['purchase_code'] = array(
			array( 'name' => __( 'Purchase Code & Auto Update', 'woocommerce-brands' ), 'type' => 'title', 'desc' => '', 'id' => 'pw_woocommerce_brands_general_settings' ),
			array(
				'title' => __( 'Purchase Code', 'woocommerce-brands' ),
				'desc' 		=> __( 'Purchase Code In Envato', 'woocommerce-brands' ),
				'id' 		=> 'pw_woo_brand_activate_purchase_code',
				'css' 		=> 'width:300px;',
				'default'	=> 'Free',
				'type' 		=> 'text',
				'desc_tip'	=>  true,
			...
			array(
				'title' => __( 'Email', 'woocommerce-brands' ),
				'desc' 		=>  '',
				'id' 		=> 'pw_woo_brand_activate_email',
				'css' 		=> 'width:200px;',
				'default'	=> '',
				'type' 		=> 'text',
				'desc_tip'	=>  true,
