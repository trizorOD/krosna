				...
				vc_map( array(
					...
					"params" => array(
									...
									array(
										"type" => "dropdown",
										"class" => "",
										"heading" => __("Display Brands",  'woocommerce-brands' ),
										"param_name" => "pw_featured",
										"value" => array(
											__("All Brand's" ,  'woocommerce-brands' )=>"all",
											__("Only Featured Brand" ,  'woocommerce-brands' )=>"featured",
											__("Exclude Featured Brand" ,  'woocommerce-brands' )=>"exclude_featured",
											),
										"description" => "",
									),
									array(
