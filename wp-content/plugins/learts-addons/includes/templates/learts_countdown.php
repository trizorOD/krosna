 ...
 * @var $countdown_opts
 * @var $digit_color
 * @var $digit_border_color
 * @var $digit_bg_color
 * @var $digit_font_size
 * @var $digit_line_height
 * @var $use_theme_fonts
 * @var $digit_google_fonts
 * @var $unit_color
 * @var $unit_font_size
 * @var $unit_line_height
 ...
 * @var $css
 * Shortcode class
 * @var $this WPBakeryShortCode_Learts_Countdown
 */

wp_enqueue_style( 'kbw-countdown', LEARTS_LIBS_URI . '/kbw-countdown/css/jquery.countdown.css' );

wp_enqueue_script( 'kbw-plugin',
	LEARTS_LIBS_URI . '/kbw-plugin/js/jquery.plugin.min.js',
	array( 'jquery' ),
	null,
	true );

wp_enqueue_script( 'kbw-countdown',
	LEARTS_LIBS_URI . '/kbw-countdown/js/jquery.countdown.min.js',
	array( 'jquery' ),
	null,
	true );
...
$css_id        = Learts_VC::get_learts_shortcode_id( 'learts-countdown' );
