...
if ($title_learts) {
	$css_class .= ' title-learts';
}

if ($use_font_face == 'modesty') {
	$css_class .= ' use_font_modesty';
}

if ($use_font_face == 'notera') {
	$css_class .= ' use_font_notera';
}

if ($use_font_face == 'futura') {
	$css_class .= ' use_font_futura';
}
