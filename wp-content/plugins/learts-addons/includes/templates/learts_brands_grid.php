 ...
 * @var $css
 * Shortcode class
 * @var $this WPBakeryShortCode_Learts_Brands_Grid
 */
...
$css_id = Learts_VC::get_learts_shortcode_id( 'learts-brands-grid' );

$column_width = Learts_VC::calculate_column_width( $columns );
