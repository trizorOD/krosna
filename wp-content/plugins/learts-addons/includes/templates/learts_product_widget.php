 ...
 *
 * Shortcode class
 * @var $this WPBakeryShortCode_Learts_Product_Widget
 */
...
$css_id = Learts_VC::get_learts_shortcode_id( 'learts-product-widget' );
...
<div class="<?php echo esc_attr( trim( $css_class ) ); ?>" id="<?php echo esc_attr( $css_id ); ?>"
	...
	$product_loop             = Learts_VC::get_products_by_datasource( $data_source, $atts );
		...
		while ( $product_loop->have_posts() ) {
			...
			wc_get_template( 'content-widget-product.php',
				array(
					...
					'img_size'     => Learts_VC::convert_image_size( $img_size ),
				) );
