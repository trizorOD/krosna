...
if ( ! class_exists( 'learts_Widget_Price_Filter' ) ) {

	add_action( 'widgets_init', 'load_learts_price_filter_widget' );

	function load_learts_price_filter_widget() {
		register_widget( 'learts_Widget_Price_Filter', 1 );
	}

	class learts_Widget_Price_Filter extends WPH_Widget {
		...
		function __construct() {
			...
			$args = array(
				...
				'label'       => '&#x1f4b2; &nbsp;' . esc_html__( 'Learts Price filter', 'learts' ),
				// Widget Backend Description
				'description' => esc_html__( 'Price filter list', 'learts' ),
			);
			...
			$args['fields'] = array(
				array(
					'id'   => 'title',
					'type' => 'text',
					'std'  => esc_html__( 'Price filter', 'learts' ),
