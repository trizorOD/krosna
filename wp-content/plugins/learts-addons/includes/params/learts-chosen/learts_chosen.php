...
if ( ! class_exists( 'Learts_Chosen' ) ) {
	...
	class Learts_Chosen {
		...
		public function admin_scripts() {
			wp_enqueue_style( 'learts-chosen', LEARTS_ADDONS_URL . '/includes/params/learts-chosen/chosen.min.css' );
			wp_enqueue_script( 'learts-chosen', LEARTS_ADDONS_URL . '/includes/params/learts-chosen/chosen.jquery.min.js', array( 'jquery' ), null, true );
		}
		...
		public function render( $settings, $value ) {
			...
			$output = '<div class="learts-chosen">';
			$output .= '<input name="' . $param_name . '" class="wpb_vc_param_value ' . $param_name . ' learts_chosen_items_' . $param_name .
			           '" id="learts-chosen-items" type="hidden" value="' . $value . '" />';
			$output .= '<select name="' . $param_name . '"' . ' id="' . $id . '" class="wpb_vc_param_value wpb-select ' .
			           $param_name . ' ' . $settings['type'] . '_field"' . ( $multiple ? ' multiple="multiple"' : '' ) . ' data-class="learts_chosen_items_' . $param_name . '">';
