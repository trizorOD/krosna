 ...
 * @package Learts
 */
class WPBakeryShortCode_Learts_Social extends WPBakeryShortCode {
...
vc_map( array(
	'name'        => esc_html__( 'Social Links', 'learts-addons' ),
	'base'        => 'learts_social',
	'icon'        => 'learts-element-icon-social-links',
	'category'    => sprintf( esc_html__( 'by %s', 'learts-addons' ), LEARTS_ADDONS_THEME_NAME ),
	'description' => esc_html__( 'Display share icon social.', 'learts-addons' ),
	'params'      => array(
		array(
			'type'       => 'number',
			'param_name' => 'icon_font_size',
			'heading'    => esc_html__( 'Icon font size', 'learts-addons' ),
			'value'      => 24,
			'min'        => 10,
			'max'        => 50,
			'step'       => 1,
		...
		array(
			'type'       => 'number',
			'param_name' => 'spacing',
			'heading'    => esc_html__( 'Spacing', 'learts-addons' ),
			'value'      => 10,
			'min'        => 0,
			'max'        => 50,
			'step'       => 1,
		...
		array(
			...
			'heading'     => esc_html__( 'Icon background shape', 'learts-addons' ),
			'value'       => array(
			...
			'std'         => 'circle',
			'description' => esc_html__( 'Select background shape and style for icons', 'learts-addons' ),
		),
		array(
			'group'      => esc_html__( 'Social', 'learts-addons' ),
			'type'       => 'dropdown',
			'param_name' => 'source',
			'heading'    => esc_html__( 'Select Social Link', 'learts-addons' ),
			'value'      => array(
				esc_html__( 'Default (From Theme Options)', 'learts-addons' ) => 'default',
		...
		array(
			...
			'heading'    => esc_html__( 'Icon color on hover', 'learts-addons' ),
			'value'      => '#333333',
		),
		array(
			'group'      => esc_html__( 'Color', 'learts-addons' ),
		...
		array(
			...
			'heading'    => esc_html__( 'Icon background color on hover', 'learts-addons' ),
			'value'      => '#ffffff',
			'dependency' => array(
				'element'            => 'icon_shape',
				'value_not_equal_to' => 'none',
