...
/**
 * Learts Countdown Shortcode
 *
 * @version 1.0
 * @package Learts
 */
class WPBakeryShortCode_Learts_Countdown extends WPBakeryShortCode {
...
vc_map( array(
	'name'        => esc_html__( 'Countdown', 'learts-addons' ),
	'base'        => 'learts_countdown',
	'icon'        => 'learts-element-icon-countdown',
	'description' => esc_html__( 'Countdown timer', 'learts-addons' ),
	...
	'params'      => array(
		...
		array(
			'type'        => 'datetimepicker',
			'heading'     => esc_html__( 'Target time for Countdown', 'learts-addons' ),
			'param_name'  => 'datetime',
			'admin_label' => true,
		),
		array(
			'type'       => 'dropdown',
			'heading'    => esc_html__( 'Countdown timer depends on', 'learts-addons' ),
			'param_name' => 'time_zone',
			'value'      => array(
				esc_html__( 'WordPress Defined Timezone', 'learts-addons' ) => 'wp',
				__( 'User\'s System Timezone', 'learts-addons' )            => 'user',
			),
		),
		array(
			'type'       => 'checkbox',
			'heading'    => esc_html__( 'Select time units to display in countdown timer', 'learts-addons' ),
			'param_name' => 'countdown_opts',
			'value'      => array(
				esc_html__( 'Years', 'learts-addons' )   => 'syear',
				esc_html__( 'Months', 'learts-addons' )  => 'smonth',
				esc_html__( 'Weeks', 'learts-addons' )   => 'sweek',
				esc_html__( 'Days', 'learts-addons' )    => 'sday',
				esc_html__( 'Hours', 'learts-addons' )   => 'shr',
				esc_html__( 'Minutes', 'learts-addons' ) => 'smin',
				esc_html__( 'Seconds', 'learts-addons' ) => 'ssec',
			),
		),
		Learts_VC::get_param( 'el_class' ),
		// Digit.
		array(
			'group'      => esc_html__( 'Digit', 'learts-addons' ),
			'type'       => 'colorpicker',
		...
		array(
			'group'      => esc_html__( 'Digit', 'learts-addons' ),
			'type'       => 'number',
			'heading'    => esc_html__( 'Line height', 'learts-addons' ),
		...
		array(
			'group'       => esc_html__( 'Digit', 'learts-addons' ),
			'type'        => 'checkbox',
			'heading'     => esc_html__( 'Use theme default font family?', 'learts-addons' ),
			'param_name'  => 'use_theme_fonts',
			'value'       => array( esc_html__( 'Yes', 'learts-addons' ) => 'yes' ),
			'description' => esc_html__( 'Use font family from the theme.', 'learts-addons' ),
			'std'         => 'yes',
		),
		array(
			'group'      => esc_html__( 'Digit', 'learts-addons' ),
			...
			'settings'   => array(
				'fields' => array(
					'font_family_description' => esc_html__( 'Select font family.', 'learts-addons' ),
					'font_style_description'  => esc_html__( 'Select font styling.', 'learts-addons' ),
				),
			),
			'dependency' => array(
		...
		// Unit.
		array(
			'group'      => esc_html__( 'Unit', 'learts-addons' ),
			'type'       => 'colorpicker',
			'heading'    => esc_html__( 'Text color', 'learts-addons' ),
		...
		// String translation.
		array(
			'group'      => esc_html__( 'String Translation', 'learts-addons' ),
			'type'       => 'textfield',
			'heading'    => esc_html__( 'Second (Singular)', 'learts-addons' ),
			'param_name' => 'str_second_singular',
			'value'      => esc_html__( 'Second', 'learts-addons' ),
		),
		array(
			'group'      => esc_html__( 'String Translation', 'learts-addons' ),
			'type'       => 'textfield',
			'heading'    => esc_html__( 'Seconds (Plural)', 'learts-addons' ),
			'param_name' => 'str_second_plural',
			'value'      => esc_html__( 'Seconds', 'learts-addons' ),
		),
		array(
			'group'      => esc_html__( 'String Translation', 'learts-addons' ),
			'type'       => 'textfield',
			'heading'    => esc_html__( 'Minute (Singular)', 'learts-addons' ),
			'param_name' => 'str_minute_singular',
			'value'      => esc_html__( 'Minute', 'learts-addons' ),
		),
		array(
			'group'      => esc_html__( 'String Translation', 'learts-addons' ),
			'type'       => 'textfield',
			'heading'    => esc_html__( 'Minutes (Plural)', 'learts-addons' ),
			'param_name' => 'str_minute_plural',
			'value'      => esc_html__( 'Minutes', 'learts-addons' ),
		),
		array(
			'group'      => esc_html__( 'String Translation', 'learts-addons' ),
			'type'       => 'textfield',
			'heading'    => esc_html__( 'Hour (Singular)', 'learts-addons' ),
			'param_name' => 'str_hour_singular',
			'value'      => esc_html__( 'Hour', 'learts-addons' ),
		),
		array(
			'group'      => esc_html__( 'String Translation', 'learts-addons' ),
			'type'       => 'textfield',
			'heading'    => esc_html__( 'Hours (Plural)', 'learts-addons' ),
			'param_name' => 'str_hour_plural',
			'value'      => esc_html__( 'Hours', 'learts-addons' ),
		),
		array(
			'group'      => esc_html__( 'String Translation', 'learts-addons' ),
			'type'       => 'textfield',
			'heading'    => esc_html__( 'Day (Singular)', 'learts-addons' ),
			'param_name' => 'str_day_singular',
			'value'      => esc_html__( 'Day', 'learts-addons' ),
		),
		array(
			'group'      => esc_html__( 'String Translation', 'learts-addons' ),
			'type'       => 'textfield',
			'heading'    => esc_html__( 'Days (Plural)', 'learts-addons' ),
			'param_name' => 'str_day_plural',
			'value'      => esc_html__( 'Days', 'learts-addons' ),
		),
		array(
			'group'      => esc_html__( 'String Translation', 'learts-addons' ),
			'type'       => 'textfield',
			'heading'    => esc_html__( 'Week (Singular)', 'learts-addons' ),
			'param_name' => 'str_week_singular',
			'value'      => esc_html__( 'Week', 'learts-addons' ),
		),
		array(
			'group'      => esc_html__( 'String Translation', 'learts-addons' ),
			'type'       => 'textfield',
			'heading'    => esc_html__( 'Weeks (Plural)', 'learts-addons' ),
			'param_name' => 'str_week_plural',
			'value'      => esc_html__( 'Weeks', 'learts-addons' ),
		),
		array(
			'group'      => esc_html__( 'String Translation', 'learts-addons' ),
			'type'       => 'textfield',
			'heading'    => esc_html__( 'Month (Singular)', 'learts-addons' ),
			'param_name' => 'str_month_singular',
			'value'      => esc_html__( 'Month', 'learts-addons' ),
		),
		array(
			'group'      => esc_html__( 'String Translation', 'learts-addons' ),
			'type'       => 'textfield',
			'heading'    => esc_html__( 'Months (Plural)', 'learts-addons' ),
			'param_name' => 'str_month_plural',
			'value'      => esc_html__( 'Months', 'learts-addons' ),
		),
		array(
			'group'      => esc_html__( 'String Translation', 'learts-addons' ),
			'type'       => 'textfield',
			'heading'    => esc_html__( 'Year (Singular)', 'learts-addons' ),
			'param_name' => 'str_year_singular',
			'value'      => esc_html__( 'Year', 'learts-addons' ),
		),
		array(
			'group'      => esc_html__( 'String Translation', 'learts-addons' ),
			'type'       => 'textfield',
			'heading'    => esc_html__( 'Years (Plural)', 'learts-addons' ),
			'param_name' => 'str_year_plural',
			'value'      => esc_html__( 'Years', 'learts-addons' ),
		),
