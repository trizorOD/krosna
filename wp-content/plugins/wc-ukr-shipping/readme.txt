...
* Массовове создани / удаление накладных.
...
* С версии 1.10.0 плагин может использовать сервис WC Ukraine Shipping Cloud для получения свежей информации о населенных пунктах, городах и отделениях Новой Почты.

== Installation ==

= Minimum Requirements =

* PHP 7.1 or greater is recommended
...
* Базовая интеграция с сервисом WC Ukraine Shipping Cloud (подробности в документации).
