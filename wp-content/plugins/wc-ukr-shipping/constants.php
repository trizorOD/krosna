...
define('WCUS_OPTION_CLOUD_CONNECTED', 'wcus_cloud_connected');
define('WCUS_OPTION_CLOUD_API_KEY', 'wcus_cloud_api_key');
define('WCUS_OPTION_CLOUD_PUBLIC_API_UUID', 'wcus_cloud_public_api_uuid');