...
class Mobile_Detect {
	 ...
	 */
	static function getPhoneDevices() {
	 ...
	 */
	static function getTabletDevices() {
	 ...
	 */
	static function getOperatingSystems() {
	 ...
	 */
	static function getMobileDetectionRules() {
		static $rules;
