...
if ( ! empty( $_POST['import_sample_data'] ) ) {
	...
	if ( $importer_version == '1' ) {
		...
		$ic_importer->set_logger( new WP_Importer_Logger_CLI() );
	}
	...
	echo '<script type="text/javascript">document.title="' . esc_html__( 'Initializing Data',
			'insight-core' ) . '";</script>';
}
