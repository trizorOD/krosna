...
! defined( 'WOOBT_VERSION' ) && define( 'WOOBT_VERSION', '4.1.3' );
			...
			class WPCleverWoobt {
				...
				function __construct() {
					...
					add_action( 'woocommerce_before_mini_cart_contents', array(
						$this,
						'woobt_before_mini_cart_contents'
					), 10 );
				...
				function woobt_before_mini_cart_contents() {
				...
				function woobt_get_cart_contents( $cart_contents ) {
					...
					remove_filter( 'woocommerce_get_cart_contents', array( $this, 'woobt_get_cart_contents' ) );
